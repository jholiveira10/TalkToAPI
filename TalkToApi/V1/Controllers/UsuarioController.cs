...
namespace TalkToApi.V1.Controllers
{
    ...
    public class UsuarioController : ControllerBase
    {
        ...
        public UsuarioController(IMapper mapper, IUsuarioRepository usuarioRepository, SignInManager<ApplicationUser> signInManager, UserManager<ApplicationUser> userManager, ITokenRepository tokenRepository)
        {
            _mapper = mapper;
        ...
        public ActionResult Renovar([FromBody]TokenDTO tokenDTO)
        {
            ...
            //Gerar um novo Token/Refresh Token - Salvar no Banco
